...
class Mahasiswa:
    ...
    def tampilkan(self):
        ...
        print(tabulate(self.dataMahasiswa, headers=[
            'NO', 'Nim', 'Nama', 'Tugas', 'Uts', 'Uan', 'Nilai Akhir'], tablefmt="fancy_grid"))
            ...
            while True:
                ...
                if editApa == 1:
                    ...
                    nilai_akhir = (self.dataMahasiswa['Tugas'][namaIndex] * 30 / 100) + (
                        self.dataMahasiswa['Uts'][namaIndex] * 35 / 100) + (newUas * 35 / 100)
...
# melakukan pengulangan menggunakan while sampai user menekan huruf Q perulangan akan
no = 0
...
while True:
    ...
    if tanya == "C":
        # Melalukan perulangan hingga user memilih n maka perulangan akan berhenti
        while True:
            no += 1
        ...
        # jiks tanya == Q maka keluar dari program
    elif tanya == "Q":
        print("")
